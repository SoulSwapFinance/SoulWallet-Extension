...
import { ProviderErrorType } from 'background/KoniTypes';
import { SubWalletEvmProvider } from 'page/SubWalleEvmProvider';
import { EvmProvider } from '@soul-wallet/extension-inject/src/types';
