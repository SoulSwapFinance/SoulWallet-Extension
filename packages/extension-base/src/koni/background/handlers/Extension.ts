...
import { _API_OPTIONS_CHAIN_GROUP, _DEFAULT_MANTA_ZK_CHAIN, _MANTA_ZK_CHAIN_GROUP, _ZK_ASSET_PREFIX } from '@soul-wallet/extension-base/services/chain-service/constants';
import { _ChainConnectionStatus, _ChainState, _NetworkUpsertParams, _ValidateCustomAssetRequest, _ValidateCustomAssetResponse, EnableChainParams, EnableMultiChainParams } from '@soul-wallet/extension-base/services/chain-service/types';
import { _getChainNativeTokenBasicInfo, _getContractAddressOfToken, _getEvmChainId, _getSubstrateGenesisHash, _getTokenMinAmount, _isAssetSmartContractNft, _isChainEvmCompatible, _isCustomAsset, _isLocalToken, _isMantaZkAsset, _isNativeToken, _isTokenEvmSmartContract, _isTokenTransferredByEvm } from '@soul-wallet/extension-base/services/chain-service/utils';
...
import { SWTransaction, SWTransactionResponse, SWTransactionResult, TransactionEmitter, ValidateTransactionResponseInput } from '@soul-wallet/extension-base/services/transaction-service/types';
import { WALLET_CONNECT_EIP155_NAMESPACE } from '@soul-wallet/extension-base/services/wallet-connect-service/constants';
import { isProposalExpired, isSupportWalletConnectChain, isSupportWalletConnectNamespace } from '@soul-wallet/extension-base/services/wallet-connect-service/helpers';
import { ResultApproveWalletConnectSession, WalletConnectNotSupportRequest, WalletConnectSessionRequest } from '@soul-wallet/extension-base/services/wallet-connect-service/types';
import { isSameAddress, reformatAddress, uniqueStringArray } from '@soul-wallet/extension-base/utils';
import { convertSubjectInfoToAddresses } from '@soul-wallet/extension-base/utils/address';
import { createTransactionFromRLP, signatureToHex, Transaction as QrTransaction } from '@soul-wallet/extension-base/utils/eth';
import { parseContractInput, parseEvmRlp } from '@soul-wallet/extension-base/utils/eth/parseTransaction';
