...
import { DEFAULT_AUTO_LOCK_TIME } from '@soul-wallet/extension-base/src/services/setting-service/constants';
import { SWTransaction, SWTransactionResponse, SWTransactionResult, TransactionEmitter, ValidateTransactionResponseInput } from '@soul-wallet/extension-base/src/services/transaction-service/types';
import { WALLET_CONNECT_EIP155_NAMESPACE } from '@soul-wallet/extension-base/src/services/wallet-connect-service/constants';
import { isProposalExpired, isSupportWalletConnectChain, isSupportWalletConnectNamespace } from '@soul-wallet/extension-base/src/services/wallet-connect-service/helpers';
import { ResultApproveWalletConnectSession, WalletConnectNotSupportRequest, WalletConnectSessionRequest } from '@soul-wallet/extension-base/src/services/wallet-connect-service/types';
import { isSameAddress, reformatAddress, uniqueStringArray } from '@soul-wallet/extension-base/src/utils';
import { convertSubjectInfoToAddresses } from '@soul-wallet/extension-base/src/utils/address';
import { createTransactionFromRLP, signatureToHex, Transaction as QrTransaction } from '@soul-wallet/extension-base/src/utils/eth';
import { parseContractInput, parseEvmRlp } from '@soul-wallet/extension-base/src/utils/eth/parseTransaction';
import { balanceFormatter, formatNumber } from '@soul-wallet/extension-base/src/utils/number';
