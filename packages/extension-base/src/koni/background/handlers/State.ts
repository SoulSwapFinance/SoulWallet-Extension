...
import { EvmProviderError } from '@soul-wallet/extension-base/src/background/errors/EvmProviderError';
import { withErrorLog } from '@soul-wallet/extension-base/src/background/handlers/helpers';
import { isSubscriptionRunning, unsubscribe } from '@soul-wallet/extension-base/src/background/handlers/subscriptions';
import { AccountRefMap, AddTokenRequestExternal, AmountData, APIItemState, ApiMap, AuthRequestV2, BalanceItem, BalanceJson, BasicTxErrorType, ChainStakingMetadata, ChainType, ConfirmationsQueue, CrowdloanItem, CrowdloanJson, CurrentAccountInfo, EvmProviderErrorType, EvmSendTransactionParams, EvmSendTransactionRequest, EvmSignatureRequest, ExternalRequestPromise, ExternalRequestPromiseStatus, ExtrinsicType, MantaAuthorizationContext, MantaPayConfig, MantaPaySyncState, NftCollection, NftItem, NftJson, NominatorMetadata, RequestAccountExportPrivateKey, RequestCheckPublicAndSecretKey, RequestConfirmationComplete, RequestSettingsType, ResponseAccountExportPrivateKey, ResponseCheckPublicAndSecretKey, ServiceInfo, SingleModeJson, StakingItem, StakingJson, StakingRewardItem, StakingRewardJson, StakingType, UiSettings } from '@soul-wallet/extension-base/src/background/KoniTypes';
import { AccountJson, RequestAuthorizeTab, RequestRpcSend, RequestRpcSubscribe, RequestRpcUnsubscribe, RequestSign, ResponseRpcListProviders, ResponseSigning } from '@soul-wallet/extension-base/src/background/types';
import { ALL_ACCOUNT_KEY, ALL_GENESIS_HASH, MANTA_PAY_BALANCE_INTERVAL } from '@soul-wallet/extension-base/src/constants';
import { BalanceService } from '@soul-wallet/extension-base/src/services/balance-service';
import { ServiceStatus } from '@soul-wallet/extension-base/src/services/base/types';
import { ChainService } from '@soul-wallet/extension-base/src/services/chain-service';
import { _DEFAULT_MANTA_ZK_CHAIN, _MANTA_ZK_CHAIN_GROUP, _PREDEFINED_SINGLE_MODES } from '@soul-wallet/extension-base/src/services/chain-service/constants';
import { _ChainState, _NetworkUpsertParams, _ValidateCustomAssetRequest } from '@soul-wallet/extension-base/src/services/chain-service/types';
import { _getEvmChainId, _getSubstrateGenesisHash, _getTokenOnChainAssetId, _isAssetFungibleToken, _isChainEnabled, _isChainTestNet, _isSubstrateParaChain, _parseMetadataForSmartContractAsset } from '@soul-wallet/extension-base/src/services/chain-service/utils';
import { EventService } from '@soul-wallet/extension-base/src/services/event-service';
import { HistoryService } from '@soul-wallet/extension-base/src/services/history-service';
import { KeyringService } from '@soul-wallet/extension-base/src/services/keyring-service';
import MigrationService from '@soul-wallet/extension-base/src/services/migration-service';
import NotificationService from '@soul-wallet/extension-base/src/services/notification-service/NotificationService';
import { PriceService } from '@soul-wallet/extension-base/src/services/price-service';
import RequestService from '@soul-wallet/extension-base/src/services/request-service';
import { AuthUrls, MetaRequest, SignRequest } from '@soul-wallet/extension-base/src/services/request-service/types';
import SettingService from '@soul-wallet/extension-base/src/services/setting-service/SettingService';
import DatabaseService from '@soul-wallet/extension-base/src/services/storage-service/DatabaseService';
import { SubscanService } from '@soul-wallet/extension-base/src/services/subscan-service';
import { SUBSCAN_CHAIN_MAP_REVERSE } from '@soul-wallet/extension-base/src/services/subscan-service/subscan-chain-map';
import TransactionService from '@soul-wallet/extension-base/src/services/transaction-service';
import { TransactionEventResponse } from '@soul-wallet/extension-base/src/services/transaction-service/types';
import WalletConnectService from '@soul-wallet/extension-base/src/services/wallet-connect-service';
import AccountRefStore from '@soul-wallet/extension-base/src/stores/AccountRef';
import { stripUrl } from '@soul-wallet/extension-base/src/utils';
import { isContractAddress, parseContractInput } from '@soul-wallet/extension-base/src/utils/eth/parseTransaction';
