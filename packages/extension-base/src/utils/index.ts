...
import { CrowdloanParaState, MobileOS, NetworkJson } from '@soul-wallet/extension-base/src/background/KoniTypes';
...
import { getOS } from '@soul-wallet/extension-base/src/utils/environment';
