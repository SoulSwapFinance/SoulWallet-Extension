...
import { ChainStakingMetadata, StakingType } from '@soul-wallet/extension-base/src/background/KoniTypes';
import BaseStoreWithChain from '@soul-wallet/extension-base/src/services/storage-service/db-stores/BaseStoreWithChain';
