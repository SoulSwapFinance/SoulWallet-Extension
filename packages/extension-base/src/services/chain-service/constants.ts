...
export const _CHAIN_INFO_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/ChainInfo.json`;
export const _CHAIN_ASSET_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/ChainAsset.json`;
export const _ASSET_REF_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/AssetRef.json`;
export const _MULTI_CHAIN_ASSET_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/MultiChainAsset.json`;
export const _CHAIN_LOGO_MAP_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/ChainLogoMap.json`;
export const _ASSET_LOGO_MAP_SRC = `https://raw.githubusercontent.com/SoulSwapFinance/SoulWallet-ChainList/master/packages/chain-list/src/data/AssetLogoMap.json`;
