...
import { MetadataItem } from '@soul-wallet/extension-base/src/background/KoniTypes';
import { _API_OPTIONS_CHAIN_GROUP, API_AUTO_CONNECT_MS, API_CONNECT_TIMEOUT } from '@soul-wallet/extension-base/src/services/chain-service/constants';
import { getSubstrateConnectProvider } from '@soul-wallet/extension-base/src/services/chain-service/handler/light-client';
import { DEFAULT_AUX } from '@soul-wallet/extension-base/src/services/chain-service/handler/SubstrateChainHandler';
import { _ApiOptions } from '@soul-wallet/extension-base/src/services/chain-service/handler/types';
import { _ChainConnectionStatus, _SubstrateApi, _SubstrateDefaultFormatBalance } from '@soul-wallet/extension-base/src/services/chain-service/types';
import { createPromiseHandler, PromiseHandler } from '@soul-wallet/extension-base/src/utils/promise';
