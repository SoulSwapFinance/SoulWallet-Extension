...
import { _MANTA_ZK_CHAIN_GROUP, _ZK_ASSET_PREFIX } from '@soul-wallet/extension-base/src/services/chain-service/constants';
import { _ChainState, _CUSTOM_PREFIX, _SMART_CONTRACT_STANDARDS } from '@soul-wallet/extension-base/src/services/chain-service/types';
