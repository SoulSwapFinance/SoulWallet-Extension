...
import { AuthRequestV2, ResultResolver } from 'background/KoniTypes';
import { AccountAuthType, AuthorizeRequest, RequestAuthorizeTab, Resolver } from 'background/types';
import { ChainService } from 'services/chain-service';
import { _isChainEvmCompatible } from 'services/chain-service/utils';
import { KeyringService } from 'services/keyring-service';
import RequestService from 'services/request-service';
import { PREDEFINED_CHAIN_DAPP_CHAIN_MAP, WEB_APP_URL } from 'services/request-service/constants';
import { AuthUrls } from 'services/request-service/types';
import AuthorizeStore from 'stores/Authorize';
import { getDomainFromUrl, stripUrl } from 'utils';
