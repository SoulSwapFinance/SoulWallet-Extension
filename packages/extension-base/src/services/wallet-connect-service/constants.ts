...
import { EIP155_SIGNING_METHODS, POLKADOT_SIGNING_METHODS, WalletConnectSigningMethod } from '@soul-wallet/extension-base/src/services/wallet-connect-service/types';
import { isMobile } from '@soul-wallet/extension-base/src/utils';
