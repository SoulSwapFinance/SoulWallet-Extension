...
import { ConfirmationResult } from '@soul-wallet/extension-base/background/KoniTypes';
import { AccountJson, ConfirmationRequestBase } from '@soul-wallet/extension-base/background/types';
