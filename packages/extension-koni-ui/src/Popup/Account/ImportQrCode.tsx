...
import { checkPublicAndPrivateKey, createAccountWithSecret } from '@soul-wallet/extension-koni-ui/messaging';
...
import { importQrScan } from '@soul-wallet/extension-koni-ui/utils/scanner/attach';
      ...
      >
        <div className={CN('container')}>
          <div className='sub-title'>
            {t("Please make sure that you have granted SoulWallet the access to your device's camera.")}
          </div>
          <div className='logo'>
            <DualLogo
              leftLogo={(
