...
import type { AccountJson, AuthorizeRequest, MetadataRequest, ResponseAuthorizeList, ResponseDeriveValidate, ResponseJsonGetAccountInfo, ResponseSigningIsLocked, SigningRequest, WindowOpenParams } from '@soul-wallet/extension-base/background/types';
